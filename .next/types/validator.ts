...
// Validate ../../app/api/upload/club-logo/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/upload/club-logo">> = Specific
  const handler = {} as typeof import("../../app/api/upload/club-logo/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
